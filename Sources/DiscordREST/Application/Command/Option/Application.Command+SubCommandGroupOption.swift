//
//  Application.Command+SubCommandGroupOption.swift
//
//
...
extension Application.Command {
    public struct SubCommandGroupOption: SubOption {
        public let type = OptionType.subCommandGroup
...
extension Application.Command.SubCommandGroupOption: Codable {
